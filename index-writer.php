...
<figure>
  ...
  <figcaption class="blockquote-footer">
     <cite title="Source Title"><h6>Mencetak Generasi Muda Dengan Membaca</h6></cite>
        ...
        <div class="container">
            <p align = "right">
                <a href="add-writer.php"><button class="btn btn-sm btn-info">Tambah Penulis</button></a>
            </p>
            <div class="row">
            <?php
            ...
            $query = "SELECT * FROM writers"; // Query untuk menampilkan data produk
        ...
        <div class="row g-0">
            <div class="col-md-4">
                <img src="img/<?= $d['photo']; ?>" class="card-img-top" alt="..." hight : 10%>
            </div>
        <div class="col-md-8">
            <div class="card-body">
                ...
                <p class="card-text"><b>No Telpon : </b><?= $d['phone_number']; ?></p>
                <p class="card-text"><b>Alamat : </b><?= $d['address']; ?></p>
                <p class="card-text"><b>Email : </b><?= $d['email']; ?></p>
                <a href="edit-writer.php?id=<?=$d['id'];?>"><button class="btn btn-sm btn-primary">Update</button></a>
                <a href="hapus-writer.php?id=<?=$d['id'];?>"><button class="btn btn-sm btn-danger">Hapus</button></a>
            </div>
        </div>
    </div>
            <?php
