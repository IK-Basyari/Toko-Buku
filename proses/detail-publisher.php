...
<body class="p-3 mb-2 bg-light">
    ...
    <br>
    <div class="judul">		
	    <center><h1>Detail Penerbit</h1></center>
	</div>
    <br>
    ...
    <div class="container">
    <p align = "right">
        <a href="index-publisher.php" class="btn btn-info">Kembali</a>
    </p>        
        <div class="card mb-3">
                <div class="col-md-8">
                    <div class="card-body">   
                        <h3 class="card-title">Nama Perusahaan : <?= $d['company_name']; ?></h3>
                        <h4 class="card-text">Alamat : <?= $d['address']; ?></h4>
                        <h4 class="card-text">Telephone : <?= $d['phone']; ?></h4>
                    </div>
                </div> 
        </div>
    <?php } ?>
