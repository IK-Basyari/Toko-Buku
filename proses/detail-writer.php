...
<body class="p-3 mb-2 bg-light">
    ...
    <p align = "right">
        ...
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="img/<?= $d['photo']; ?>" style="width:300px" alt="...">
                </div>
                <div class="col-md-8">
                    <div class="card-body">   
                        <h3 class="card-title">Nama : <?= $d['name']; ?></h3>
                        <h4 class="card-text">Nomor Telephone : <?= $d['phone_number'] ?></h4>
                        <h4 class="card-text">Alamat : <?= $d['address']; ?></h4>
                        <h4 class="card-text">Email : <?= $d['email'] ?></h4>
                    </div>
                </div> 
            </div>
        </div>
